...
import Logo from "../assets/Brand Logo Files/RGB/SECONDARY LOGO LOCKUP/SVG/ALLMOND IM PURPLE.svg";
const Footer = () => {
  return (
      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <img class="w-auto h-[200px]" src={Logo} alt="" />

            <p class="text-base leading-relaxed text-[gray]/50 mt-7 font-medium">
              Almond is a fintech company that empowers local communities by
              providing secure, accessible, and innovative financial solutions
              to promote economic growth and financial literacy.
            </p>
        ...
        <p class="text-sm text-center text-gray-600">
          © Copyright 2021, All Rights Reserved by Almond Inc.
        </p>
      </div>
    </section>
  );
